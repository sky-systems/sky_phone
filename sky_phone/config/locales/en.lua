        ...
        AdminPanel = {
            ...
            configurator = {
                ...
                descriptions = {
                    ...
                    phoneBlockWhenDead = "Enabled by default. Blocks phone use, ends ringing and active calls/video calls and streams, and disconnects both radio frequencies while dead, unconscious or in laststand. Detects sky_ambulancejob state bags (skyAmbulanceDead, dead, isdead) and ESX/Qbox/QBCore state automatically. Disabling permits use in these states.",
                    phoneBlockWhenCuffed = "Enabled by default. Blocks phone use and ends calls, streams and radio while handcuffed. Uses sky_policejob state bags (ishandcuffed, skyCuffType), ESX police handcuff state and Qbox/QBCore police metadata. No edits to voice or job resources are required.",
