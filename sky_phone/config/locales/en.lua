    ...
    Nui = {
        ...
        Apps = {
            ...
            citywarn = {
                ...
                mapTitle = "Warning areas", mapBody = "Highlighted areas show the approximate scope of active alerts.",
