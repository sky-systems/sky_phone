Locales["en"] = {
    ...
    DeviceErrors = {
        ...
        player_incapacitated = "You cannot use your phone while dead or unconscious.",
        player_cuffed = "You cannot use your phone while handcuffed.",
        phone_not_owned = "You need a phone item to use the radio.",
        request_cancelled = "The connection was cancelled.",
    },
    Payphone = {
    ...
    Nui = {
        ...
        FaceId = {
            title = "Face ID",
            setupBody = "Unlock your phone with a glance. You can set up Face ID now or later in Settings.",
            pinFallback = "Your device passcode remains available at any time.",
            requiresPin = "Create a device passcode first. It is your backup when Face ID is unavailable.",
            ...
            usePin = "Use Passcode",
            errors = {
                face_id_not_enabled = "Face ID is not set up on this phone. Use your passcode.",
                face_id_not_recognized = "Face not recognized. Try again or use the device passcode.",
                face_id_unavailable = "Face ID is currently unavailable.",
                face_id_masked = "Remove your mask to use Face ID, or enter your passcode.",
                invalid_passcode = "Incorrect device passcode.",
                passcode_locked = "Too many attempts. Wait before entering your passcode again.",
        ...
        Common = {
            ...
            signOutBody = "You will only be signed out of {app}. Your other iFruit apps stay signed in.",
        ...
        AdminPanel = {
            ...
            configurator = {
                ...
                disabledBody = "Enable the configurator at the beginning of config.lua and restart sky_phone. Until then, file values remain active and editing is locked.",
                manualSave = "Manual save",
                refreshNotice = "Nothing is written automatically. The green check verifies config.lua and media.lua in SQL and refreshes the active server, client, media and UI configuration immediately.",
                ...
                crewlinkPingCooldownLabel = "Ping cooldown (seconds)",
                crewlinkBlipLabels = {
                    Enabled = "Show map blips",
                ...
                crewlinkQuickPingLabels = {
                    Enabled = "Enable quick ping",
                    DefaultKey = "Default keyboard key",
                },
                ...
                descriptions = {
                    ...
                    citywarnPublishers = "Choose which jobs may publish CityWarn warnings. Enter the internal job name, for example mechanic, and click Add job. Set its permissions, then save with the green check.",
                    citywarnPublisher = "Permissions for the job {name}. This job must already exist on your server. If RequireDuty is enabled, employees must be on duty to publish.",
                    citywarnPublisherMinimumGrade = "Lowest job grade allowed to publish. 0 allows every grade; 2 allows grade 2 and above. Enter the grade number, not its name.",
                    citywarnPublisherMaximumSeverity = "Highest level this job may publish: information (notice), warning (warning), danger (danger) or extreme (extreme danger). Lower levels are also allowed.",
                    citywarnPublisherCityWide = "On: this job may warn the whole city. Off: warnings must target a limited area on the map.",
                    citywarnPublisherCategories = "Add one category per row: public_safety (public safety), police (police), fire (fire), medical (medical), infrastructure (infrastructure) or evacuation (evacuation). Use these exact codes. An empty list allows no warnings.",
                    citywarnCategoryColor = "Color in #RRGGBB format for this warning category. Applies to GTA blips, radius areas and the CityWarn app. Text contrast adjusts automatically.",
                    faceIdMaskWhitelist = "Exceptions for masks on ped component 1, up to 256 entries. No mask (drawable 0) is always allowed. Each exception applies only to the specified ped model.",
                    faceIdMaskModel = "Ped model name, e.g. mp_m_freemode_01 or mp_f_freemode_01. Custom models are supported (up to 64 letters, digits, underscores or hyphens).",
                    faceIdMaskDrawable = "Global drawable ID of the allowed mask on component 1 (1-65535). IDs may differ between models and clothing packs.",
                    faceIdMaskTexture = "Allowed texture ID (0-65535). Use -1 to allow every texture of this mask.",
                    crewlinkPingCooldown = "Minimum interval per CrewLink profile between app and keybind pings (0-3600 seconds). Default: 5. Set 0 to disable. Group changes do not reset the cooldown.",
                    crewlinkBlipEnabled = "Shows opted-in members and pings of the active crew on the GTA map and minimap.",
                    crewlinkBlipSprite = "GTA sprite ID for crew members (0-65535). Default: 126.",
                    crewlinkBlipPingSprite = "GTA sprite ID for crew pings (0-65535). Default: 280.",
                    crewlinkBlipCategoryId = "Named GTA map category (12-133). Default: 13. Use an ID not used by other map categories.",
                    crewlinkBlipCategoryName = "Custom map legend category name, up to 99 bytes without formatting codes. Default: CrewLink.",
                    crewlinkBlipScale = "Map icon scale (0.1-5). Default: 0.8.",
                    crewlinkQuickPingEnabled = "Allows a keyboard ping at your current position in your active crew, subject to crew permissions and ping limits.",
                    crewlinkQuickPingDefaultKey = "FiveM keyboard key name, for example NUMPAD5 or F6. Applies to new key bindings after reconnecting; players keep their own setting under Settings > Key Bindings > FiveM.",
                    citywarnBlipSprite = "GTA blip sprite ID. Default: 161 (signal). Sprite 10 draws a large outline; use the separate radius setting for a fixed map area.",
                    citywarnBlipDisplay = "Display mode: 0/1/7 hidden; 2/6 map and minimap, selectable; 3/4 map only; 5/9 minimap only; 8/10 both, not selectable.",
                    citywarnBlipShortRange = "When enabled, the minimap shows the blip only nearby. Default: on.",
                    citywarnBlipCategoryId = "Custom named map category ID from 12 to 133. Default: 12. Choose an unused ID to avoid sharing another category.",
                    citywarnBlipCategoryName = "Map legend category name, up to 99 bytes without GTA formatting. Default: CityWarn.",
                    citywarnBlipGroupByCategory = "Groups warnings under the category name in the map legend, hiding individual short titles. Leave off to show each short title. Default: off.",
                    citywarnBlipRadiusEnabled = "Shows the same fixed area around each located warning on the GTA map and in CityWarn. The area has no separate GTA map legend entry.",
                    citywarnBlipRadius = "Shared radius for the GTA map and CityWarn app, in metres (1-50000). Default: 100. Independent of the warning notification area.",
                    companyLogo = "Admin-managed company logo (HTTPS image URL).",
                    companyName = "Company name shown in Discover (maximum 32 characters).",
                    companyCover = "Admin-managed cover image (HTTPS URL). Leave empty to hide the cover.",
                    featureToggle = "Turns {name} on or off.",
                    boolean = "Controls whether {name} is allowed.",
                    number = "Numeric value for {name}. Enter the number without a unit or Lua calculation.",
                    text = "Sets the text value used for {name}.",
                    optionalText = "Sets the optional value for {name}; switch it off to disable it.",
                    ...
                    hosts = "Allowed domains for {name}. Example: media.example.com. Add one domain per row, without https:// or a file path.",
                    milliseconds = "Timing for {name} in milliseconds. Example: 10000 = 10 seconds. Enter only 10000.",
                    seconds = "Timing for {name} in seconds. Example: 60 = 1 minute. Enter only 60.",
                    rateLimit = "Maximum {name} actions per minute. Example: 20 allows up to 20 actions in 60 seconds.",
                    byteLimit = "Maximum size for {name} in bytes. Example: 15728640 = 15 MiB. Enter 15728640, not 15 or a Lua calculation.",
                    textLimit = "Maximum length for {name}. Example: 200 limits the text to 200 characters.",
                    ...
                    displayText = "Text shown to players for {name}. Enter the text directly, without Lua quotation marks.",
                    phoneNumber = "Sets the phone or service number used for {name}.",
                    routing = "Controls how incoming requests are routed for {name}.",
                    command = "Chat command for {name}. Enter the name without the leading slash. Example: phonepanel is opened with /phonepanel.",
                    locale = "Language code for {name}. Examples: de = German, en = English, es = Spanish.",
                    ...
                    garageSystem = "Garage provider: use msk for msk_garage. Auto detects jg-advancedgarages first, then msk_garage, then the framework garage.",
                    giphyApiKey = "API key from developers.giphy.com → Dashboard → Create an API Key. Paste your own key, not the website URL. Used for GIF search; it does not enable photo imports.",
                    gifRating = "Maximum GIPHY content rating. Enter g, pg, pg-13 or r. Example: pg-13.",
                    fiveManageApiKey = "Create a token with Media access in the FiveManage dashboard → Tokens and paste it here. Required for camera uploads and FiveManage import sources, including external links imported through that source.",
                    fiveManageBaseUrl = "FiveManage API endpoint, not an image link. Normally keep https://api.fivemanage.com/api/v3/file. Paste the image URL in Photos → Import instead.",
                    importEnabled = "Allows imports of external HTTPS images and videos in Photos. The import button appears only when at least one enabled, valid source under Websites is accessible to the player.",
                    importWebsites = "To set up FiveManage imports, enter your own FiveManage.ApiKey and enable Import and the source. Add the domain of your image host to AllowedMediaHosts and save with the green check. Paste your own direct HTTPS image URL in Photos → Import.",
                    importSource = "One import source shown in Photos, for example FiveManage. Expand it to configure the adapter, allowed domains and media types.",
                    importSourceId = "Unique internal source ID, for example city_media. Use 1–64 lowercase letters, digits, underscores or hyphens. Keep the ID stable after importing media.",
                    importSourceLabel = "Source name players see in Photos. Example: City Wallpapers. Maximum 64 characters.",
                    importSourceEnabled = "Enables this source. It appears in Photos only if its adapter settings are valid and the player has any RequiredAce permission. For FiveManage, also set the API key.",
                    importAdapter = "Enter fivemanage for a FiveManage source (API key and Path required), or manifest for your own JSON media catalog (ManifestUrl required). Adding a domain does not create an adapter.",
                    importApiKey = "Optional FiveManage token for this source. Leave empty to use FiveManage.ApiKey. Paste only your own token with Media access, not a URL.",
                    importPath = "FiveManage catalog folder, for example sky_phone/imports. Keep this value when allowing an external image host; add its domain under AllowedMediaHosts.",
                    importMediaTypes = "Allowed media types: photo for images, video for videos. Add each as a separate list entry. For wallpapers, include photo.",
                    importHosts = "Add each domain as a separate entry, for example media.example.com. No https://, path or *. Subdomains are included. Keep fivemanage.com for FiveManage media. Paste the complete image URL in Photos → Import.",
                    importManifestUrl = "HTTPS URL of your own JSON media catalog, for example https://media.example.com/sky-phone/media.json. Requires version: 1 and items with id, filename, type, mimeType, size and url. This field is not for a JPG link.",
                    importRequiredAce = "Optional ACE permission for this source, for example sky_phone.import.city_media. Leave empty to allow all players who can use Photos.",
                    importAuth = "Manifest authentication: none for a public catalog, bearer with TokenConvar, or header with Header and ValueConvar. Example: Type = none for a publicly accessible media.json.",
                    importAuthConvar = "Name of the server convar containing the manifest credential, for example sky_phone_city_media_token. Set its secret value in server.cfg with set; enter only the convar name here.",
                    importAuthHeader = "HTTP header name for manifest authentication with Type = header. Example: X-API-Key. Put the convar name for its secret value in ValueConvar.",
                    wallpaperImport = "Shows external image import in the wallpaper picker. Also requires Import.Enabled and an accessible import source whose MediaTypes includes photo. Camera and existing Photos remain available independently.",
                    photoEncoding = "Image format for camera captures. Enter jpg, png or webp. Example: jpg for compressed photos.",
                    photoQuality = "Camera image quality from 0 to 1. Example: 0.95 for high quality. Higher values usually create larger JPG/WebP files; PNG ignores this setting.",
                    videoBitrate = "Video recording bitrate in kilobits per second. Example: 1500 = 1.5 Mbit/s. Higher values increase quality and upload size.",
                    callsVoiceProvider = "All controls stay in sky_phone; no pma-voice manifest entry is needed. PMA mute silences the microphone for calls, proximity and radio. SaltyChat mute uses SetPlayerAlive(false) and also affects proximity/radio; the previous voice state is restored on unmute or hangup while respecting death state. Yaca uses phone-specific exports.",
                    phoneSpeaker = "Globally enables supported phone/radio speakers. With PMA, players within 3 metres in the same routing bucket join the call: they can hear and speak. Their own calls are not interrupted.",
                    phoneBlockWhenDead = "Enabled by default. Blocks phone use and ends calls, broadcasts and both radio frequencies while dead, unconscious or in laststand. Uses ESX/Qbox/QBCore status and native death checks. Disable to allow use in these states.",
                    phoneBlockWhenCuffed = "Enabled by default. Blocks phone use and ends calls, broadcasts and radio while handcuffed. Uses framework status and native handcuff checks.",
                    radioRequirePhoneItem = "Enabled by default. Requires Phone.Item when joining or automatically rejoining radio. Only connected radio users are checked once per second; losing the last phone disconnects both frequencies even with the phone closed. Disable to allow radio without a phone item.",
                },
                table = {
                    list = "List",
                    table = "Key table",
                ...
                playerRestrictionLabels = {
                    BlockWhenDead = "Block while dead or unconscious",
                    BlockWhenCuffed = "Block while handcuffed",
                    RequirePhoneItem = "Require a phone item for radio",
                },
            },
            players = {
            ...
            credentials = {
                ...
                revealBody = "This action is server-authorized, rate-limited, and written to the admin audit log.",
                cancel = "Cancel",
            ...
            apps = {
                ...
                title = "App access",
                description = "Stage app access for this device. Nothing changes until you save.",
                installed = "Installed",
                available = "Available",
            ...
            moderation = {
                ...
                dialogs = {
                    ...
                    ["reset-passcodeBody"] = "The player can unlock this phone without the previous PIN afterward.",
                    ["change-numberTitle"] = "Change phone number?",
                    ["change-numberBody"] = "The new number must match the configured server number format and be unique.",
                    ["factory-resetTitle"] = "Factory reset this phone?",
                    ["factory-resetBody"] = "This clears local device data, app settings, security, and the linked account. This cannot be undone.",
                },
                confirm = {
            ...
            editor = {
                ...
                audit = "Audit log",
                selectPlayer = "Select a player to inspect identity, devices, credentials, and app access.",
                save = "Save changes",
                ...
                discardBody = "Your staged app or configuration changes have not been saved.",
            ...
            errors = {
                ...
                revision_conflict = "The data changed in the meantime. Reopen the section and try again.",
            ...
            webhooks = {
                ...
                videoHelp = "Videos are uploaded as Discord attachments. Oversized or unavailable files retain a visible link. Maximum 20 MiB.",
                ...
                sidebar = "Saved webhook URLs stay on the server. Changes take effect immediately and survive restarts. SkyPic settings are ready for its integration.",
                ...
                adminHelp = "Full activity logs for administrators, including private content. Use channels accessible only to staff.",
                publicHelp = "Announces public posts, stories and listings. Private profiles, messages and player identifiers are excluded. Uses only public destinations.",
                username = "Admin webhook name",
                avatarUrl = "Admin avatar URL",
                avatarHelp = "Optional HTTPS image URL. Leave empty to use the webhook’s Discord avatar.",
                ...
                routingHelp = "Actions inherit their app channel, app channels inherit the default. Disabled stops that route. File setting uses WebHooks.lua.",
                ...
                secretHelp = "Saved URLs are never displayed. Paste a new URL to replace the current one.",
                modes = {
                    file = "File setting",
                    inherit = "Inherit",
                    disabled = "Disabled",
        ...
        Apps = {
            ...
            crewlink = {
                quickPingLabel = "Meet here",
                quickPingKeybind = "CrewLink: Ping active crew",
                name = "CrewLink",
                connecting = "Connecting your crew...",
                privateNetwork = "Private location network",
                signInTitle = "Connect your Sky Cloud account",
                signInBody = "CrewLink uses your private Sky Cloud identity to keep groups and roles available across your phones.",
                ...
                welcomeBody = "Choose a private CrewLink username. Only confirmed group members can see your presence and shared location.",
                ...
                noGroupBody = "Create a crew or join friends with a private invitation code.",
                createGroup = "Create Group",
                createGroupBody = "Give your crew a recognizable name and signal colour.",
                joinGroup = "Join Group",
                joinWithCode = "Join with Code",
                joinWithCodeBody = "Enter the private eight-character code shared by a coordinator.",
                ...
                peopleNearbyBody = "Only CrewLink users within {distance} meters appear here.",
                ...
                errors = {
                    ping_cooldown = "Wait a moment before sending another crew ping.",
                    quick_ping_disabled = "CrewLink quick ping is disabled.",
            ...
            flare = {
                ...
                signInBody = "Flare profiles and matches are linked to your private Sky Cloud account.",
                createProfile = "Create your profile",
                welcome = "Find your spark",
                welcomeBody = "Build a profile and meet people across Los Santos.",
                photo = "Profile photo",
                profilePhotos = "Profile photos",
                profilePhotosBody = "Add one to six photos from Photos or Camera. Your first photo is shown first.",
                ...
                signOutBody = "This signs the whole phone out of Sky Cloud. Your Flare profile, matches and chats stay stored.",
                signingOut = "Signing Out...",
                signOutHint = "Signing out affects every app that uses Sky Cloud on this phone.",
                deleteAccount = "Delete Flare Account",
                deleteAccountTitle = "Delete your Flare account?",
                deleteAccountBody = "Your Flare profile, swipes, matches and conversations will be permanently deleted. Your Sky Cloud account and Photos library stay available.",
                ...
                discoveryOffBody = "Your profile is hidden from new people. Your existing matches and chats stay available.",
                ...
                unmatchBody = "You and {name} will disappear from each other's match lists. This cannot be undone.",
                messagePhoto = "Photo",
                gif = "GIF",
                video = "Video",
                ...
                errors = {
                    ...
                    invalid_profile_photos = "Choose or take at least one and up to six photos saved in your own Photos library.",
            ...
            picstagram = {
                ...
                registrationHint = "A Sky Cloud account is required once to create and own a Picstagram profile.",
                displayName = "Name",
                username = "Username",
                password = "Password",
                confirmPassword = "Confirm password",
                ...
                blockBody = "You will no longer see or interact with each other's Picstagram content.",
                moderation = "Moderation",
                ...
                errors = {
                    ...
                    already_registered = "This Sky Cloud account already owns a Picstagram profile.",
            ...
            feather = {
                ...
                networkBody = "Follow voices from across Los Santos and build a timeline that feels like yours.",
                ...
                authBody = "Your iFruit email is linked automatically. Use your Feather username to continue.",
                login = "Log in",
                register = "Register",
                loginTitle = "Good to see you again",
                loginBody = "Use your Feather username. Your iFruit email is linked automatically.",
                registerTitle = "Create your Feather profile",
                registerBody = "Choose a username and optional profile photo. No password is needed.",
                ...
                loginNow = "Log in",
                authTrust = "Your Feather profile is linked to your Sky Cloud account through your iFruit email.",
                ...
                welcomeBody = "Join the live conversation in Los Santos. Your Feather profile stays linked to your Sky Cloud account.",
            ...
            fliptok = {
                ...
                chooseMediaHint = "Record a video, choose a clip, or select up to 10 photos.",
                ...
                deleteVideoBody = "The video disappears from FlipTok and cannot be restored.",
                ...
                reportDetails = "Additional details (optional)",
                submitReport = "Submit report",
                reportDiscordNote = "This report is sent directly to the moderation team through Discord.",
                reportReasons = {
                    spam = "Spam or misleading",
                    harassment = "Harassment or bullying",
                    dangerous = "Dangerous activity",
                ...
                customSoundHint = "Paste a YouTube link or a direct HTTPS audio-file link.",
                customSoundPlaceholder = "https://youtu.be/... or https://example.com/song.mp3",
                customSoundFormats = "YouTube, YouTube Music, Shorts, MP3, M4A, AAC, OGG, OPUS, WAV, or WEBM",
                useCustomSound = "Use sound",
                loadingSound = "Loading sound",
                invalidCustomSoundLink = "Use a YouTube link or a direct public HTTPS audio-file link.",
                ...
                logout = "Sign Out",
                loginBody = "Sign in to continue with your videos, follows, and saved posts.",
                ...
                passwordPlaceholder = "At least 8 characters",
                confirmPasswordPlaceholder = "Enter password again",
                registrationHint = "A Sky Cloud account is required once to create and own a FlipTok profile.",
                accountDetails = "Account details",
                profileDetails = "Profile details",
                account = "Account",
                signOutTitle = "Sign out of FlipTok?",
                signOutBody = "Your profile and videos stay online. This phone will return to the FlipTok sign-in screen.",
                signingOut = "Signing Out...",
                accountTypes = {
                    person = "Person",
                    business = "Business",
                ...
                errors = {
                    invalid_video = "Check the FlipTok details.",
                    invalid_music_url = "Use a valid YouTube or direct HTTPS audio-file link.",
                    ...
                    invalid_password = "Password must be 8–72 characters.",
                    invalid_credentials = "Username or password is incorrect.",
                    already_registered = "This Sky Cloud account already owns a registered FlipTok profile.",
                    handle_taken = "This username is already taken.",
                    ...
                    request_failed = "Your FlipTok request could not be completed. Try again.",
                    rate_limited = "Too many actions. Try again shortly.",
                    not_authenticated = "Sign in to Sky Cloud first.",
            ...
            darkchat = {
                ...
                signInBody = "DarkChat identities are linked to your private Sky Cloud account.",
                signInHint = "Sign in through Settings to continue.",
                createIdentity = "Create Dark Identity",
                createIdentityBody = "Create a private identity before starting a DarkChat conversation.",
                security = "Security",
                privateNetwork = "Private invitation-only network",
                noResults = "No Results",
                noResultsBody = "Try another alias or Dark-ID.",
                noChats = "No Private Chats",
                noChatsBody = "Connect with a Dark-ID or invitation code. There is no public search.",
                newChat = "New Chat",
                to = "To:",
                connectPrivately = "Connect privately",
                newChatBody = "Enter another person's Dark-ID or invitation code. You can share your own ID from your profile.",
                darkIdOrInvite = "Dark-ID or invitation code",
                continue = "Continue",
                contacts = "DarkChat Contacts",
                contactsHint = "Saved private identities appear only on your DarkChat account.",
                ...
                privacyDisclaimer = "DarkChat stores messages on the server and does not claim end-to-end encryption.",
                ...
                signOut = "Sign Out",
                signOutTitle = "Sign out of Sky Cloud?",
                signOutBody = "This signs the whole phone out of Sky Cloud. Your DarkChat profile and messages remain stored.",
                signingOut = "Signing Out...",
                signOutHint = "Signing out affects every app that uses Sky Cloud on this phone.",
                deleteProfile = "Delete DarkChat Profile",
                deleteProfileTitle = "Delete DarkChat profile?",
                deleteProfileBody = "Your identity, contacts and DarkChat conversations will be permanently deleted.",
                deletingProfile = "Deleting...",
                unknownIdentity = "Unknown Identity",
                unknownIdentityBody = "Only continue if you expected this identity. The account is not discoverable through public search.",
            ...
            messages = {
                ...
                blockContactBody = "{name} will no longer be able to call or message this SIM.",
            ...
            companies = {
                ...
                feedback = {
                    ...
                    dispatchEnabled = "Dispatch duty enabled. Company calls will reach you first.",
                    dispatchDisabled = "Dispatch duty ended. You can still receive company calls.",
            ...
            phone = {
                ...
                errors = {
                    ...
                    voice_unavailable = "The configured phone voice service is unavailable.",
                    call_not_connected = "Connect the call before changing its audio controls.",
                    speaker_unavailable = "Speaker mode is not available for the configured phone voice service.",
                    speaker_unsupported = "The configured phone voice service does not support speaker mode.",
                    mute_unavailable = "Mute is not available for the configured phone voice service.",
                    mute_unsupported = "The configured phone voice service does not support mute.",
                    inventory_full = "There is no room for the ejected SIM card.",
                    request_failed = "The phone request failed.",
                    operation_in_progress = "Another phone operation is already in progress.",
                    sim_request_expired = "The SIM selection expired. Use the SIM card again.",
            ...
            crypto = {
                ...
                portfolio = {
                    ...
                    insightBody = "Your holdings are valued against the latest synthetic server prices.",
                },
                quick = {
                    trade = "Trade",
                    send = "Send",
                ...
                markets = {
                    ...
                    notice = "Prices are synthetic and have no real-world value. Every trade is checked against finite exchange liquidity.",
                ...
                marketDetail = {
                    ...
                    today = "Today",
                    description = "The reference price is generated by the server. Executable prices use a protected short-lived quote.",
                ...
                trade = {
                    ...
                    protectedBody = "VaultX validates price, liquidity, balance and limits before execution.",
                    review = "Order review",
                    price = "Quote price",
                    gross = "Gross",
                    fee = "Exchange fee",
                    total = "Total",
                    quoteExpiry = "This server quote expires after 8 seconds and can only be used once.",
                    getQuote = "Get protected quote",
                    confirm = "Confirm trade",
                },
                settlement = {
                    depositBody = "Move bank funds into your settled VaultX cash balance.",
                    withdrawBody = "Return settled VaultX cash to your character's bank account.",
                ...
                transfer = {
                    ...
                    keyBody = "Verify the recipient before selecting an asset. Cash can never be sent here.",
                    ...
                    protectedBody = "VaultX rechecks recipient, ownership, quantity and balance on the server, then books both wallets together.",
                    confirm = "Send crypto securely",
                },
                activity = {
                    title = "Financial activity",
                    empty = "No activity",
                    emptyBody = "Deposits, withdrawals, trades and crypto transfers will appear here.",
                ...
                profile = {
                    ...
                    walletKeyBody = "Share this key to receive crypto. It cannot access your account.",
                    copyKey = "Copy",
                    copied = "Copied",
                    shareKey = "Share",
                    ...
                    editBody = "Update your handle or set a new password. Your current password confirms identity changes.",
                    ...
                    passwordSecurity = "Passwords use memory-hard hashing and are never shown again.",
                    saved = "Profile saved securely.",
                    save = "Save profile",
                    saveChanges = "Save changes",
                    securityTitle = "Protected profile",
                    securityBody = "Your profile stays bound to this framework character and financial session.",
                },
                activityTypes = {
                    buy = "Asset purchase",
                    sell = "Asset sale",
                ...
                errors = {
                    invalid_profile = "Check your VaultX profile settings.",
                    ...
                    invalid_password = "Use 8–72 characters with uppercase, lowercase, a number, and a special character.",
            ...
            billing = {
                ...
                notifications = {
                    newInvoice = "New invoice from {issuer}: {amount}",
                },
                errors = {
            ...
            skyride = {
                ...
                playerDriverNotice = "SkyRide matches you with real player drivers. A driver must be online and accept your request.",
                ...
                statusBody = {
                    searching = "Your request is waiting for an available player driver to accept it.",
                ...
                errors = {
                    ...
                    destination_too_far = "Move closer to the destination to complete the ride.",
                    ...
                    invalid_profile_name = "Your profile name must contain 2 to 50 characters.",
                    invalid_profile_image = "Choose a profile photo from your own gallery.",
                    tip_failed = "The tip could not be processed.",
                    insufficient_funds = "Your selected payment method has insufficient funds.",
                    rate_limited = "Please wait a moment before trying again.",
            ...
            house = {
                ...
                offlineBody = "Start a supported housing resource or review Config.Housing.",
                ...
                noCandidatesBody = "A person must be inside the property before you can give them a key.",
                ...
                errors = {
                    ...
                    capability_unavailable = "This property provider does not support that control.",
                    ...
                    keyholder_offline = "Offline keys must be revoked through the property menu.",
            ...
            minesweeper = {
                ...
                lostBody = "A mine was hidden there. Mark suspicious fields and try again.",
            ...
            neonDrop = {
                ...
                lines = "Lines",
                mainMenu = "Main Menu",
                menuBody = "Rotate and place falling energy shapes. Every cleared row increases your charge.",
            ...
            camera = {
                ...
                errors = {
                    ...
                    media_provider_rate_limited = "The camera upload service is busy. Try again shortly.",
            ...
            calendar = {
                ...
                signInBody = "Sign in to Sky Cloud in Settings to sync appointments and receive reminders.",
                views = {
                    compact = "Compact",
                    stacked = "Stacked",
                    details = "Details",
            ...
            citymarkt = {
                ...
                publish = "Publish",
                addPhotos = "Add photos",
                addPhotosBody = "Choose up to six photos from Photos or take new ones. Photos are optional and the first becomes the cover.",
            ...
            localPages = {
                ...
                authBody = "Your iFruit email is linked automatically. Use your Local Pages username to continue.",
                login = "Sign in",
                register = "Register",
                ...
                registerBody = "Choose a username and optional profile photo. Your iFruit email stays linked.",
                ...
                cityMarktComposeHint = "Review the listing and publish it when you are ready.",
                cityMarktPhotosHint = "The CityMarkt listing photos will be included.",
                authErrors = {
                    no_ifruit_account = "Sign in to your Sky Cloud account in Settings first.",
                    invalid_username = "Use 3-24 lowercase letters, numbers, dots or underscores.",
                    profile_not_found = "No Local Pages profile exists for this iFruit email.",
            ...
            citywarn = {
                ...
                mapBody = "The map marks active warning locations. Open a warning for details about the affected area.",
                ...
                settings = {
                    ...
                    locationBody = "Shows alerts for radiuses and districts. City-wide alerts always remain visible.",
                    ...
                    notificationHint = "Critical alerts may bypass focus modes. Manage sounds in the phone settings.",
                },
                notifications = {
            ...
            map = {
                ...
                placeMarkerHint = "Move the map until the crosshair is over the destination.",
                addHere = "Add Here",
            ...
            music = {
                ...
                youtubeBody = "Paste a public YouTube link. Leave the optional fields empty to use the video title and channel automatically.",
                ...
                allSongsAddedBody = "Every song in your library is already in this playlist.",
                ...
                deletePlaylistBody = "The playlist will be deleted. Songs stay in your library.",
                ...
                removeSongBody = "This YouTube song will also be removed from your playlists.",
                songCount = "{count} songs",
                emptyLibrary = "Your Library is Empty",
                emptyLibraryBody = "Add a YouTube song or ask the server owner to publish MP3 and OGG tracks.",
            ...
            easyShare = {
                ...
                errors = {
                    device_not_open = "Open and unlock your phone, then try again.",
                    device_locked = "Open and unlock your phone, then try again.",
                    device_not_owned = "Open and unlock your phone, then try again.",
                    device_not_found = "Open and unlock your phone, then try again.",
                    missing_payload = "Choose an item to share first.",
                    sim_required = "Insert a SIM card to share your own contact.",
                    ...
                    copy_failed = "Could not copy this item.",
            ...
            photos = {
                ...
                errors = {
                    ...
                    not_found = "The media item no longer exists.",
                    profile_photo_required = "This is the last photo on your Flare profile. Add another profile photo before deleting it.",
            ...
            settings = {
                ...
                hideCallerIdDescription = "Show Anonymous instead of your number when you call someone.",
                wallpaper = "Wallpaper",
                on = "On",
                off = "Off",
                ...
                accountLoginBody = "Sign in to keep your important data safe. Without a Sky Cloud account, it will be lost with the phone.",
                ...
                focus = "Focus",
                focusMode = "Focus",
                focusDescription = "Focus silences non-critical notifications while keeping alarms and important alerts available.",
                ...
                performanceModeDescription = "Blur-free glass simulation for better CEF performance",
                ultimateMode = "Ultimate Mode",
                ultimateModeDescription = "Full blur and glass effects for compatible FiveM clients",
                ...
                removeDeviceBody = "Enter your Sky Cloud password to remove this device from the account.",
                signOut = "Sign Out",
                ...
                factoryResetBody = "This cannot be undone. Local settings, apps and unsynced content are erased. Your SIM number and account-backed data remain available.",
        ...
        Realtime = {
            ...
            microphoneHelp = "Your microphone is used while you speak. Nearby voices may be included when enabled by the server.",
            ...
            help = {
                ...
                Transport = "Default: p2p, without Cloudflare or credentials. Enable optional Cloudflare SFU or TURN only for connection problems, larger audiences, or by choice. P2P uploads once per viewer; TURN works independently.",
                VideoCalls = "Use the existing contact video and FaceTime buttons. Call audio stays with the configured voice provider.",
                Picstagram = "Enable livestreams, viewer counts and livechat in Picstagram. Private profiles keep their follower restrictions.",
                FlipTok = "Enable livestreams, viewer counts and livechat in FlipTok.",
                FrameRate = "Video frame rate, 5–30 FPS. Default: 24.",
                VideoBitrateKbps = "Video upload limit per connection, 100–5000 kbit/s. Default: 1200. P2P multiplies upload by viewer count.",
                MaxVideoEdge = "Portrait video height, 240–1080 pixels. Default: 720.",
                MaxViewers = "Maximum simultaneous viewers per livestream, 1–128. Default: 32. Use low limits with P2P.",
                MaxBroadcasts = "Server-wide livestream limit, 1–32. Default: 8.",
                MaxDurationMinutes = "Maximum video session duration, 1–240 minutes. Default: 120.",
                NearbyAudio = "Mix nearby players’ NUI microphones using voice-provider talk/mute/range state. SaltyChat needs RequestTalkStates enabled. Browser microphone permission is required on each participating client.",
                NearbyDistance = "Maximum nearby voice distance, 1–30 m. Limited further by the speaker’s current voice range and routing bucket.",
                NearbyMaxSpeakers = "Maximum nearby contributors per live, 0–16. Default: 8. Their audio is mixed at the broadcaster.",
                TurnEnabled = "Generate temporary ICE credentials on the server. Create a TURN key at Cloudflare dashboard > Realtime > TURN. Set Token ID and API Token under credentials. https://developers.cloudflare.com/realtime/turn/generate-credentials/",
                ForceRelay = "Use only relayed connections for P2P. Requires TURN enabled and valid credentials. SFU connections use Cloudflare directly.",
                AppId = "Cloudflare dashboard > Realtime > SFU > Create application. Copy App ID. https://developers.cloudflare.com/realtime/sfu/https-api/",
                AppSecret = "Copy the App Secret from the same Realtime SFU application. Stored server-side; masked on reload. This is the SFU app secret, not a global account API key.",
                TurnKeyId = "Cloudflare dashboard > Realtime > TURN > Create TURN key. Copy Token ID (the TURN key ID). https://developers.cloudflare.com/realtime/turn/",
                ApiToken = "Copy API Token generated with the TURN key above. Stored only on the server; clients receive expiring ICE credentials.",
                Realtime = "Choose P2P or Cloudflare SFU and optionally TURN. Changing these settings ends active video sessions.",
                RealtimeSecrets = "SQL mode: manage credentials here. File mode: use the non-replicated server.cfg convars documented in config.lua. Never paste secrets into config.lua or use setr/sets.",
            },
            errors = {
                default = "Video could not connect. Check camera/microphone access and the server configuration.",
                ...
                rate_limited = "Please wait before trying again.",
                cloudflare_not_configured = "Cloudflare credentials are missing in the phone configuration.",
    ...
    DiscordAudit = {
        ...
        states = {
            ...
            remove = "Removed",
            restore = "Restored",
            delete_me = "Deleted for this user",
            delete_all = "Deleted for everyone",
            pending = "Pending",
            open = "Open",
            closed = "Closed",
            in_progress = "In progress",
            ...
            deleted_for_self = "Deleted for this user",
            draft_created = "Saved as draft",
            draft = "Draft",
            archived = "Archived",
            restored = "Restored",
            ...
            left = "Left",
            invited = "Invited",
            code_rotated = "Invite code renewed",
            online = "Online",
            offline = "Offline",
            arrived = "Arrived",
            started = "Started",
            ...
            unlocked = "Unlocked",
            passcode_set = "PIN enabled",
            passcode_changed = "PIN changed",
            passcode_disabled = "PIN disabled",
            passcode_reset = "PIN reset",
            password_revealed = "Password viewed by admin",
            configuration_saved = "Configuration saved",
            tone_created = "Sound added",
            tone_deleted = "Sound deleted",
            inserted = "Inserted",
            ejected = "Removed",
            recorded = "Recorded",
            verified = "Verified",
        ...
        fields = {
            simId = "SIM card ID",
            payphone = "Payphone",
            voiceProvider = "Voice system",
            extra = "Additional details",
            accept = "Accepted",
            accepted = "Accepted",
            acceptsRequests = "Accepting requests",
            accountType = "Account type",
            action = "Action",
            activityVisible = "Activity visible",
            adHeadline = "Advertisement headline",
            address = "Address",
            age = "Age",
            alias = "Alias",
            allergies = "Allergies",
            allowMemberPings = "Members may place markers",
            allowReplay = "Replay allowed",
            allowStoryReplies = "Story replies allowed",
            appId = "App ID",
            area = "Area",
            artist = "Artist",
            availability = "Availability",
            ...
            avatarId = "Profile picture ID",
            avatarSeed = "Generated profile picture variant",
            badge = "Radio badge",
            blocked = "Blocked",
            bloodType = "Blood type",
            choice = "Choice",
            ...
            coverTimeMs = "Cover frame (milliseconds)",
            coverUrl = "Cover image",
            customFare = "Custom fare",
            customMusicUrl = "Custom music link",
            destination = "Destination",
            disappearingSeconds = "Disappears after (seconds)",
            draft = "Draft",
            draftId = "Draft ID",
            ...
            hours = "Opening hours",
            idempotencyKey = "Transaction reference",
            identifier = "Contact identifier",
            ids = "Entry IDs",
            imageMediaId = "Image ID",
            imageMediaIds = "Image IDs",
            images = "Images",
            ...
            isSponsored = "Sponsored post",
            key = "Setting",
            kind = "Type",
            label = "Label",
            lifetimeSeconds = "Visible for (seconds)",
            listingId = "Listing ID",
            locationLabel = "Location name",
            logoMediaId = "Logo image ID",
            logoUrl = "Logo",
            lookingFor = "Looking for",
            mailboxId = "Mailbox ID",
            mapVisible = "Visible on map",
            marketId = "Currency ID",
            matchId = "Match ID",
            maxAge = "Maximum age",
            mediaAssetId = "Attachment ID",
            mediaDurationMs = "Media duration (milliseconds)",
            mediaMime = "File format",
            ...
            orderId = "Order ID",
            organization = "Organization",
            originalVolume = "Original audio volume",
            overheadAllowed = "Overhead labels allowed",
            overheadVisible = "Overhead label visible",
            overlayColor = "Text overlay color",
            parentId = "Parent entry ID",
            phoneNumbers = "Phone numbers",
            photoMediaIds = "Photo IDs",
            pickup = "Pickup location",
            pingId = "Map marker ID",
            plate = "License plate",
            ...
            replyToId = "Reply to entry ID",
            requestId = "Request ID",
            rideId = "Ride ID",
            role = "Role",
            saved = "Saved",
            secondaryFrequency = "Secondary radio frequency",
            serviceId = "Service ID",
            services = "Services",
            severity = "Severity",
            sharePayload = "Shared content",
            showInQuickAdd = "Visible in friend suggestions",
            ...
            startsAt = "Starts on",
            storyId = "Story ID",
            storyPrivacy = "Story visibility",
            targetId = "Target ID",
            targetSource = "Target player ID",
            targetType = "Target type",
            textOverlay = "Text overlay",
            tip = "Tip",
            tradeConfirmations = "Confirm trades",
            trimEndMs = "Clip end (milliseconds)",
            trimStartMs = "Clip start (milliseconds)",
            type = "Type",
            useCurrent = "Use current location",
            value = "Value",
            walletKey = "Wallet address",
            attachment = "Attachment",
            actorAfter = "Player details after the change",
            calleeStatus = "Recipient call status",
            previousSource = "Previous recipient ID",
            ...
            status = "Status",
            state = "Status",
            author_handle = "Platform username",
            ...
            imei = "Device number (IMEI)",
            device_imei = "Device number (IMEI)",
            id = "Entry ID",
            ...
            enabled = "Enabled",
            changes = "Changes",
            changedPaths = "Changed settings",
            changeCount = "Number of changes",
            namespace = "Settings area",
            revision = "Saved version",
            contentError = "Content could not be loaded",
            logLimit = "More content omitted",
            note = "Note",
            pinned = "Pinned",
            visibility = "Visibility",
            privacy = "Privacy",
            avatarMediaId = "Profile picture ID",
            avatar_media_id = "Profile picture ID",
            author_avatar = "Profile picture",
        ...
        titles = {
            ...
            video_created = "New video",
            video_deleted = "Video deleted",
            video_draft_created = "Video saved as draft",
            story_created = "New story",
            ...
            account_logged_in = "Signed in",
            account_logged_out = "Signed out",
            ...
            settings_edited = "Settings changed",
            settings_configuration_saved = "Settings changed",
            message_sent = "Message sent",
            call_ringing = "New call",
            call_connected = "Call answered",
            listing_created = "New listing",
            profile_edited = "Profile changed",
        },
        values = {
            public = "Public",
            everyone = "Everyone",
            ...
            admin = "Administrator",
            member = "Member",
            limitReached = "[Content limit reached]",
            circular = "[Repeated reference omitted]",
            redactedWebhook = "[Webhook URL hidden]",
            omitted = "Additional content omitted",
            rowsOmitted = "First 101 entries shown; additional content omitted",
            lookupFailed = "Content could not be loaded; submitted changes and result are shown",
            photo = "Image",
            video = "Video",
            audio = "Audio",
            yes = "Yes",
