...
Locales["en"].Nui.AdminPanel.configurator.descriptions.importWebsites = "Setup example: set FiveManage.ApiKey, enable Import and the FiveManage source, then add wallpapercave.com to AllowedMediaHosts. Save with the green check. In Photos → Import → FiveManage, paste https://wallpapercave.com/wp/wp6735117.jpg."
...
Locales["en"].Nui.AdminPanel.configurator.descriptions.importHosts = "Add each domain as a separate entry, for example wallpapercave.com. No https://, path or *. Subdomains are included. Keep fivemanage.com for FiveManage media. Paste the complete image URL in Photos → Import."
